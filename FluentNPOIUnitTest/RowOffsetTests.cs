...
namespace FluentNPOIUnitTest
{
    ...
    {
        private class RowOffsetTestData
        {
        ...
        public void WithRowOffset_ShouldOffsetTitleRow()
        {
            ...
            var mapping = new FluentMapping<RowOffsetTestData>();
            ...
            var testData = new List<RowOffsetTestData> { new RowOffsetTestData { Name = "Alice", Score = 95 } };
        ...
        public void WithRowOffset_ShouldOffsetDataRow()
        {
            ...
            var testData = new List<RowOffsetTestData>
            {
                new RowOffsetTestData { Name = "Alice", Score = 95 },
                new RowOffsetTestData { Name = "Bob", Score = 78 }
            };
        ...
        public void WithRowOffset_MultipleColumns_DifferentOffsets()
        {
            ...
            var testData = new List<RowOffsetTestData> { new RowOffsetTestData { Name = "Alice", Score = 95, Note = "Good" } };
