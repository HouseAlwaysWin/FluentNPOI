...
namespace FluentNPOI
{
    public static class FluentNPOIExtensions
    {
        ...
        {
            IRow row = sheet.GetExcelRow(rowIndex);
        ...
        private static byte[] HexToRgb(string hexColor)
        {
            ...
            {
                throw new ArgumentException("Hex color must be 6 characters long (excluding #).");
            }
        ...
        public static void SetAlignment(this ICellStyle style,
        ...
        /// <summary>
        /// Get specific column value (Optimized)
        /// </summary>
        ...
        public static IRow GetExcelRow(this ISheet sheet, int rowNum = 1)
        {
            if (rowNum < 1) rowNum = 1;
            int rowIndex = rowNum - 1;
